...
public:
    ...
    void setupUi(QWidget *FindRectCenterDlg)
    {
        ...
        btnExcludeProcess->setEnabled(false);
        ...
        btnSelectProcess->setEnabled(false);
        ...
        btnDrawLeftProcess->setEnabled(false);
        ...
        btnDrawUpProcess->setEnabled(false);
        ...
        btnDrawRightProcess->setEnabled(false);
        ...
        btnDrawBottomProcess->setEnabled(false);
        ...
        btnFitLeftProcess->setEnabled(false);
        ...
        btnFitUpProcess->setEnabled(false);
        ...
        btnFitRightProcess->setEnabled(false);
        ...
        btnFitBottomProcess->setEnabled(false);
        ...
        btnCenterProcess->setEnabled(false);
        ...
        btnJsonProcess->setEnabled(false);
    ...
    void retranslateUi(QWidget *FindRectCenterDlg)
    {
        ...
        btnUndo->setText(QCoreApplication::translate("FindRectCenterDlg", "\345\210\240\351\231\244", nullptr));
    } // retranslateUi
