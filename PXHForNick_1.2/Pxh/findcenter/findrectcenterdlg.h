...
struct AllInfoCollection
{
    ...
    std::vector<RectangleInfo> vec_AllRect;      //包含所有矩形的容器
    ...
    std::vector<LineInfo> vec_AllDrawLine; //包含所有绘制直线的容器
...
public:
    ...
    static void setAllAreaVec(RectangleInfo allRcet);
    ...
    static void setAllLineVec(LineInfo allLineVec);
