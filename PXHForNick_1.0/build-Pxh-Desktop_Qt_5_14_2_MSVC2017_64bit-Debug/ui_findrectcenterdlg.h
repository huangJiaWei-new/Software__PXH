...
public:
    ...
    void setupUi(QWidget *FindRectCenterDlg)
    {
        ...
        FindRectCenterDlg->resize(1129, 552);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1109, 496));
        ...
        widget_2->setGeometry(QRect(0, 370, 1100, 120));
